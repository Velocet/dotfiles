# Generated by Powerlevel10k configuration wizard on 2020-04-29 at 23:55 CEST.
...
# 24h time, angled separators, slanted heads, sharp tails, 2 lines, solid, no frame,
...
() {
  ...
  # typeset -g POWERLEVEL9K_ASDF_HASKELL_FORE GROUND=172
